        ...
        <div class="dish-main-box">
            <div class="dish-item">
                <div class="dish-img-box">
                    <img src="/ITPROG-MP/BACKEND-UY/images/rice.jpg" alt="Roasted Chicken">
                </div>
            ...
            <div class="dish-item">
                <div class="dish-img-box">
                    <img src="/ITPROG-MP/BACKEND-UY/images/mixed-vegetables.jpg" alt="Ceasar Salad">
                </div>
            ...
            <div class="dish-item">
                <div class="dish-img-box">
                    <img src="/ITPROG-MP/BACKEND-UY/images/mashed-potatoes.jpg" alt="Ceasar Salad">
                </div>
            ...
            <div class="dish-item">
                <div class="dish-img-box">
                    <img src="/ITPROG-MP/BACKEND-UY/images/fries.jpg" alt="Fries">
                </div>
