...
<body>
    ...
    <?php
        ...
        while ($row = mysqli_fetch_assoc($mainsResult)) {
            ...
            echo "<button type='button' class='cancel-button' onclick='cancelPrompt(\"$mainID\")'>CANCEL</button>";
  ...
  ?>
    ...
    <script>
    function cancelPrompt(mainID) {
        var hiddenDiv = document.getElementById(mainID);
        hiddenDiv.style.display = 'none'; // Hide the prompt
        document.getElementById('form-' + mainID).reset(); // Reset the form
    }
    </script>
